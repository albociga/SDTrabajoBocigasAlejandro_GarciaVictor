...
public class Principal_pruebas {
	
	//(ACTUALMENTE NO SIRVE PARA NADA, LA CREACIÓN DE TODOS DEL HASMAP CON LAS PREGUNTAS ESTA EN UN METODO EN LA CLASE "Pregunta_Rosco")
	//(EL ROSCO SE CREA ALEATORIAMENTE CON UN MÉTODO CREADO EN LA CLASE "Rosco_Final")

	/*public static void main(String[] args) {
		// Pregunta_Rosco(String enunciado, String respuesta, String e_c,boolean respondida)
...
//		Pregunta_Rosco pr10Z = new Pregunta_Rosco("", "", "Empieza", false);
		...
		Rosco_Final r = new Rosco_Final(Rosco_Final.crear_rosco_aleatorio(l));
		//System.out.println(l.get("A").toString());
		//System.out.println(l.get("A").size());
		System.out.println(r.getPreguntas());
